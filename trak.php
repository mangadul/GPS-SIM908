...
<head>
    ...
    <script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyCSWEjscX2--_RwIS65OUQORibc7DbeAuM&sensor=false"></script>

    <!-- Initialize Map and markers -->

    <script type="text/javascript">
        var myCenter=new google.maps.LatLng(107.3299484,7.0148291);
        var marker;
        var map;
        var mapProp;
...
<body>
    <?php
        ...
        <div>
            <center><br />
                <b> GPS Tracker Arduino + SIM908 DFRobot </b><br /><br />
